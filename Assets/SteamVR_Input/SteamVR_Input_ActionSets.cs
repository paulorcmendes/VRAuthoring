...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_multimediaSet p_multimediaSet;
        ...
        public static SteamVR_Input_ActionSet_multimediaSet multimediaSet
        {
            get
            {
                return SteamVR_Actions.p_multimediaSet.GetCopy<SteamVR_Input_ActionSet_multimediaSet>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_multimediaSet = ((SteamVR_Input_ActionSet_multimediaSet)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_multimediaSet>("/actions/multimediaSet")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.multimediaSet};
        }
    }
}
